...
{{--                                        <img src="dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">--}}
            ...
            <li class="dropdown notifications-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="label label-warning">{{ count($inactiveProducts) }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="header">You have {{ count($inactiveProducts) }} notifications</li>
                    @foreach($inactiveProducts as $inactiveProduct)
                        <li>
                            <!-- Inner Menu: contains the notifications -->
                            <ul class="menu">
                                <li><!-- start notification -->
                                    <a href="{{ route('products.edit', $inactiveProduct->id) }}">
                                        <i class="fa fa-users text-aqua"></i> {{ $inactiveProduct->title_en }}
                                    </a>
                                </li>
                                <!-- end notification -->
                            </ul>
