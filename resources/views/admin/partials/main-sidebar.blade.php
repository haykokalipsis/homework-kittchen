...
{{--    <li><a href="#"><i class="fa fa-link"></i> <span>Another Link</span></a></li>--}}
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{ route('categories.index') }}">List all categories</a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{ route('products.index') }}">List all products</a></li>
            <li><a href="{{ route('products.create') }}">Create new product</a></li>
        </ul>
    </li>

    <li class="treeview">
        <a href="#"><i class="fa fa-link"></i> <span>Fields</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
            <li><a href="{{ route('fields.index') }}">List all fields</a></li>
            <li><a href="{{ route('fields.create') }}">Create new field</a></li>
        </ul>
    </li>
</ul>
<!-- /.sidebar-menu -->
